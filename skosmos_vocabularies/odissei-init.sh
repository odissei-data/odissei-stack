...
curl -I -X POST -H Content-Type:text/turtle -T cbs-variables-thesaurus.ttl -G http://0.0.0.0:3030/skosmos/data --data-urlencode graph=http://cbs.nl/variables/

# ellst
echo "getting ELLST vocab"
wget 'https://thesauri.cessda.eu/rest/v1/elsst/data?format=text/turtle' --output-document=ELSST.ttl 
...
curl -I -X POST -H Content-Type:text/turtle -T TopicClassification.ttl -G http://0.0.0.0:3030/skosmos/data --data-urlencode graph=https://vocabularies.cessda.eu/vocabulary/TopicClassification
...
curl -I -X POST -H Content-Type:text/turtle -T GeneralDataFormat.ttl -G http://0.0.0.0:3030/skosmos/data --data-urlencode graph=https://vocabularies.cessda.eu/vocabulary/GeneralDataFormat
...
curl -I -X POST -H Content-Type:text/turtle -T AnalysisUnit.ttl -G http://0.0.0.0:3030/skosmos/data --data-urlencode graph=https://vocabularies.cessda.eu/vocabulary/AnalysisUnit
...
curl -I -X POST -H Content-Type:text/turtle -T TimeMethod.ttl -G http://0.0.0.0:3030/skosmos/data --data-urlencode graph=https://vocabularies.cessda.eu/vocabulary/TimeMethod
...
curl -I -X POST -H Content-Type:text/turtle -T SamplingProcedure.ttl -G http://0.0.0.0:3030/skosmos/data --data-urlencode graph=https://vocabularies.cessda.eu/vocabulary/SamplingProcedure
...
curl -I -X POST -H Content-Type:text/turtle -T TypeOfInstrument.ttl -G http://0.0.0.0:3030/skosmos/data --data-urlencode graph=https://vocabularies.cessda.eu/vocabulary/TypeOfInstrument
...
curl -I -X POST -H Content-Type:text/turtle -T DataSourceType.ttl -G http://0.0.0.0:3030/skosmos/data --data-urlencode graph=https://vocabularies.cessda.eu/vocabulary/DataSourceType
...
curl -I -X POST -H Content-Type:text/turtle -T SummaryStatistics.ttl -G http://0.0.0.0:3030/skosmos/data --data-urlencode graph=https://vocabularies.cessda.eu/vocabulary/SummaryStatistics
...
curl -I -X POST -H Content-Type:text/turtle -T ModeOfCollection.ttl -G http://0.0.0.0:3030/skosmos/data --data-urlencode graph=https://vocabularies.cessda.eu/vocabulary/ModeOfCollection
